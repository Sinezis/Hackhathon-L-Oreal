...
$(document).ready(function() {
    ...
    function scrollReveal() {
        ...
        $(".trigger").each(function() {
            var percentage = Math.floor(Math.random() * 100) + 1; // Random percentage between 1 and 100
...
$(".piesite").each(function() {
    var piePercentage = Math.floor(Math.random() * 100) + 1; // Random percentage between 1 and 100
    $(this).data("pie", piePercentage);
            if (
                scrolled + windowPercentage > offsetTop ||
                $win_height > offsetTop
            ) {
